...
**PREPRINT** 
- Okahara, H., Nakagawa, T., and Sugasawa, S. (2026). "The Bayesian Intransitive Bradley-Terry Model via Combinatorial Hodge Theory". arXiv preprint, [arXiv:2405.12157](https://arxiv.org/abs/2601.07158).

**PUBLISHED LITERATURE** 
- Okahara, H. and Tahata, K. (2026), "Modeling asymmetry in multi-way contingency tables with ordinal categories via *f*-divergence". *Statistical Papers*. <span style="color: red;">[open access]</span> ([publication](https://link.springer.com/article/10.1007/s00362-025-01782-y), [arXiv](https://arxiv.org/abs/2405.12157)).  
